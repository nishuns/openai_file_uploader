...
class ModernApp(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Separate File and Folder selection buttons
        self.file_btn = QtWidgets.QPushButton("Select Files", self)
        self.file_btn.setGeometry(20, 120, 150, 40)
        self.file_btn.clicked.connect(self.open_file_dialog)

        self.folder_btn = QtWidgets.QPushButton("Select Folder", self)
        self.folder_btn.setGeometry(200, 120, 150, 40)
        ...
        self.upload_btn.setGeometry(380, 120, 150, 40)
        ...
        self.vector_store_id_display.setGeometry(20, 300, 450, 40)  # Updated height
        self.copy_btn = QtWidgets.QPushButton("Copy", self)
        self.copy_btn.setGeometry(470, 300, 80, 40)  # Updated height
    ...
    def upload_process(self, openai_key, custom_vector_store_id=None):
        ...
        try:
            # Upload each file to OpenAI and collect the file IDs
            ...
            # Ensure the file IDs are attached to the vector store
